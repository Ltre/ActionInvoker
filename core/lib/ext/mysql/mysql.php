...
class AiMySQL {
	...
	public static function insert(BaseEntity $be){
		...
		$conn->commit();
		//echo "insert into $table ( $props ) values( $values );<br>";
	 ...
	 * @param 返回二维数组，一级元素表示一条记录，二级元素表示字段或伪列（可用数字索引或列名来取值）
	 */
