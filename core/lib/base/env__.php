 ...
 * 默认值为：'core/config/'。
 * 格式：路径要以项目根目录为起点，不能以“/”开头，必须以“/”结尾
 * 如果要配置多个保存位置，就需要用“|”隔开。如：'core/config/|core/config/myconfig/'。
 */
define('USER_CONFIG_DIRS', 'core/config/');
...
/*
 * 配置403页面的路径
 * 默认值：core/tpl/403.php
 */
define('PAGE_403', 'core/tpl/403.php');
